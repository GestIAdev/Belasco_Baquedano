...
export const menuData: MenuChapter[] = [
  ...
  },
  {
    ...
    platos: [
      {
        id: 100,
        nombre: 'Menú Degustación Clásico',
        descripcion: 'Una selección de nuestros platos más emblemáticos, maridados con vinos de nuestra bodega.',
        precio: 150,
        categoria: 'menu',
        imageUrl: '/images/platos/menu-degustacion.webp',
        imagenMiniatura: '/images/platos/menu-degustacion-thumb.webp',
    ...
    platos: [
      {
        ...
        imageUrl: '/images/platos/menu-chef.webp',
        imagenMiniatura: '/images/platos/menu-chef-thumb.webp',
